...
export function DashboardPage() {
  return (
    <div className="grid grid-cols-1 [grid-template-rows:auto_auto_auto] md:[grid-template-columns:1.4fr_1fr] md:[grid-template-rows:auto_1fr_auto] gap-3 h-dvh w-dvw p-3 bg-background text-foreground">
      ...
      <div className="md:[grid-column:2/3] md:[grid-row:1/3] min-h-0 flex flex-col gap-3 order-2 md:order-none">
        {/* <div className="flex items-center justify-end">
          <ThemeToggle />
        </div> */}
        <div className="md:max-h-[calc(100dvh-1rem)] md:overflow-y-auto pr-1">
          <WindDataPanel />
        </div>
      </div>
